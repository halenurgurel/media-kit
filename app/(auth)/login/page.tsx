  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-cream-50 p-8">
      <Card className="w-full max-w-sm">
        <h1 className="mb-6 text-2xl font-semibold text-charcoal-900">Log in</h1>
          ...
          <div>
            <div className="flex items-center justify-between">
              ...
              <Link
                ...
                className="mb-1 text-sm font-medium text-mauve-800 hover:underline"
              >
                Forgot password?
              </Link>
            </div>
        ...
        <p className="mt-4 text-center text-sm text-charcoal-600">
          ...
          <Link href="/register" className="font-medium text-mauve-800 hover:underline">
            Sign up
          </Link>
        </p>
      </Card>
